...
{
    /// <summary>
    /// Enumerator for <see cref="UnsafeBlittableTrie{T}"/> that yields key-value pairs.
    /// Unlike <see cref="UnsafeTrieEnumerator{T}"/>, this enumerator does not hold a reference
